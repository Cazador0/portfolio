      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Showcasing innovative solutions from Enterprise applications, automation, and web applications
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredProjects.map((project, index) => (
              ...
              >
                <Card
                  className="group h-full overflow-hidden hover:shadow-xl transition-all duration-300 border-border/50 hover:border-primary/50"
